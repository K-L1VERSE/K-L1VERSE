...
public class MateController {
  ...
  @PostMapping
  public ResponseEntity<MateDTO> createMate(@RequestBody MateDTO mateDto) throws URISyntaxException {
    MateDTO createdMate = mateService.createMate(mateDto);
    return ResponseEntity.created(new URI("/mates/" + createdMate.getMateId())).body(createdMate);
  }

  @PutMapping("/{boardId}")
  public ResponseEntity<MateDTO> updateMate(@PathVariable Long boardId, @RequestBody MateDTO mateDto) {
